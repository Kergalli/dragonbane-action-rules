...
export class DragonbaneUtils {
    ...
    static getSetting(moduleId, settingName, fallback) {
        try {
            ...
            console.warn(`${moduleId} | Failed to get setting ${settingName}:`, error);
            return fallback;
        }
    }
    ...
    static debugLog(moduleId, component, message) {
        ...
        try {
            ...
            // Fallback to safe logging if settings fail
            console.log(`${correctModuleId} | ${component}: ${message} (debug mode unknown)`);
        }
    }
    ...
    static hasToppleFeature(weapon) {
        return DragonbaneUtils.hasWeaponFeature(weapon, "DoD.weaponFeatureTypes.toppling", "toppling");
    }
    ...
    static hasLongProperty(weapon) {
        return DragonbaneUtils.hasWeaponFeature(weapon, "DoD.weaponFeatureTypes.long", "long");
    }
    ...
    static hasThrownFeature(weapon) {
        return DragonbaneUtils.hasWeaponFeature(weapon, "DoD.weaponFeatureTypes.thrown", "thrown");
    }
