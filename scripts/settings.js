...
export class DragonbaneSettings {
  ...
  register() {
    ...
    this.registerGrudgeTrackingSettings();
  ...
  registerValidationSettings() {
    game.settings.register(
      this.moduleId,
      DragonbaneSettings.SETTINGS.ENFORCE_TARGET_SELECTION,
      {
    ...
    game.settings.register(
      this.moduleId,
      DragonbaneSettings.SETTINGS.ENFORCE_RANGE_CHECKING,
      {
        name: game.i18n.localize(
  ...
  registerDisplaySettings() {
    ...
    game.settings.register(
      this.moduleId,
      DragonbaneSettings.SETTINGS.SHOW_PARRY_DURABILITY,
      {
        name: game.i18n.localize(
  ...
  registerOptionalRulesSettings() {
    game.settings.register(
      this.moduleId,
      DragonbaneSettings.SETTINGS.ENABLE_SHOVE_REMINDERS,
      {
        name: game.i18n.localize(
    ...
    game.settings.register(
      this.moduleId,
      DragonbaneSettings.SETTINGS.ENABLE_PARRY_MOVEMENT_REMINDERS,
      {
        name: game.i18n.localize(
    ...
    game.settings.register(
      this.moduleId,
      DragonbaneSettings.SETTINGS.ENABLE_DODGE_MOVEMENT_REMINDERS,
      {
        name: game.i18n.localize(
  ...
  registerEncumbranceSettings() {
    game.settings.register(
      this.moduleId,
      DragonbaneSettings.SETTINGS.ENABLE_ENCUMBRANCE_MONITORING,
      {
        name: game.i18n.localize(
    ...
    game.settings.register(
      this.moduleId,
      DragonbaneSettings.SETTINGS.ENCUMBRANCE_MONITOR_FOLDER,
      {
        name: game.i18n.localize(
    ...
    game.settings.register(
      this.moduleId,
      DragonbaneSettings.SETTINGS.ENCUMBRANCE_STATUS_EFFECT,
      {
        name: game.i18n.localize(
    ...
    game.settings.register(
      this.moduleId,
      DragonbaneSettings.SETTINGS.ENCUMBRANCE_CHAT_NOTIFICATIONS,
      {
        name: game.i18n.localize(
  ...
  registerYZEIntegrationSettings() {
    game.settings.register(
      this.moduleId,
      DragonbaneSettings.SETTINGS.ENABLE_YZE_INTEGRATION,
      {
        name: game.i18n.localize(
    ...
    game.settings.register(
      this.moduleId,
      DragonbaneSettings.SETTINGS.YZE_CUSTOM_EXCLUSIONS,
      {
        name: game.i18n.localize(
  ...
  /**
   * Register grudge tracking settings
   */
  registerGrudgeTrackingSettings() {
    game.settings.register(
      this.moduleId,
      DragonbaneSettings.SETTINGS.ENABLE_GRUDGE_TRACKING,
      {
        name: game.i18n.localize(
  ...
  registerDebugSettings() {
    game.settings.register(
      this.moduleId,
      DragonbaneSettings.SETTINGS.DEBUG_MODE,
      {
        name: game.i18n.localize(
          "DRAGONBANE_ACTION_RULES.settings.debugMode.name"
        ),
        hint: game.i18n.localize(
          "DRAGONBANE_ACTION_RULES.settings.debugMode.hint"
        ),
        scope: "world",
        config: true,
        type: Boolean,
  ...
  get(setting, fallback = null) {
    try {
      ...
      console.warn(
        `${this.moduleId} | Failed to get setting ${setting}:`,
        error
      );
      return fallback;
    }
